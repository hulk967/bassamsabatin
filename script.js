...
async function loadData(){
  ...
  try{
    ...
    projects = (await tableData('projects',fallbackProjects))
...
function applySettings(){
  ...
  if(heroEyebrow && settings.heroEyebrow){
  ...
  if(heroLead && settings.heroLead){
    heroLead.textContent = settings.heroLead;
  }
  ...
  if(serviceTitle){
    serviceTitle.textContent = settings.servicesTitle;
  }
